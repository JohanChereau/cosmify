    ...
    >
      ...
      <Card>
        ...
        <p className="muted-copy">
          Cosmify contains no telemetry or remote content. Network access is limited to signed
          update checks and release downloads through GitHub Releases.
        </p>
      </Card>
      ...
      <Card>
        <CardHeader
          title="About Cosmify"
          description="Information about this installation of Cosmify."
        />

        <div className="setting-row">
          <div>
            <div className="setting-row__label">Version</div>
            <div className="setting-row__description">Current installed version of Cosmify.</div>
          </div>
